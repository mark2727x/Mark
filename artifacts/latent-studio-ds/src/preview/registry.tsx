...
export const DESIGN_SYSTEM = {
  title: 'Latent Studio Design System',
  description:
    'Dark, warm, technical — burnt-orange primary on near-black surfaces. Space Grotesk · Instrument Serif · JetBrains Mono. Sharp corners, high contrast, grid-ruled.',
} as const;
