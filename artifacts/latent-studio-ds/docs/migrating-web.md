# Migrating web UI to Latent Studio Design System

Read `artifacts/latent-studio-ds/docs/AGENTS.md` and
`artifacts/latent-studio-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/latent-studio-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/latent-studio-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/latent-studio-ds/hooks/use-toast`
