# Consuming Latent Studio Design System in Expo apps

Read `artifacts/latent-studio-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/latent-studio-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/latent-studio-ds/tokens";
...
import { useColors } from "@workspace/latent-studio-ds/hooks/use-colors";
...
import { Card } from "@workspace/latent-studio-ds/components/native/card";
```
...
Import and render
`@workspace/latent-studio-ds/components/native/button`, then run Expo
