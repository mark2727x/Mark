 ...
 */
export const verifyEmail = async (verifyEmailInput: VerifyEmailInput, options?: Parameters<typeof customFetch>[1]): Promise<AuthResponse> => {
 ...
 */
export const resendVerification = async (resendVerificationInput: ResendVerificationInput, options?: Parameters<typeof customFetch>[1]): Promise<ResendVerification200> => {
